...
Define os tokens visuais (cor, tipografia, elemento-assinatura, motion e
acessibilidade) que todas as páginas e componentes do site do restaurante devem
seguir, evitando estilo inconsistente ou o padrão genérico de UI gerada por IA.
